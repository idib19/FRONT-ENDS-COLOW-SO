  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <Card className="p-4">
        ...
        <div className="border rounded p-2 mt-1">5000</div>
      </Card>
      
      <Card className="p-4">
        <h3 className="text-sm font-semibold mb-2">Solde en FCFA</h3>
        <div className="text-sm text-muted-foreground">Date et Heure</div>
        <div className="border rounded p-2 mt-1">25000</div>
      </Card>
      
      <Card className="p-4">
        <h3 className="text-sm font-semibold mb-2">Rechargements MASTER</h3>
